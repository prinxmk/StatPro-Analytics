...
class QVBoxLayout; class QTableWidget; class QListWidget; class QTreeWidget; class QLabel; class QTabWidget; class QPlainTextEdit; class QLineEdit; class QPushButton; class QComboBox;
namespace StatPro {
...
private:
    void buildInterface(); void buildRibbon(); void buildVariablesPanel(); void buildPropertiesPanel(); void buildDataCommandBar(QVBoxLayout* parentLayout); void refreshDataView(); void refreshDataView(const QVector<int>& rows); void refreshVariables(); void refreshProperties(int variableIndex=-1); void updateTitle(); void applyTheme(); void updateStatus();
    int selectedVariableColumn() const; void selectVariableColumn(int column);
